...
//
// Code generated for Simulink model 'proj'.
//
// Model version                  : 1.3
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Sun Nov 17 16:48:38 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"proj\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(proj_M, (NULL));
        proj_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(proj_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(proj_M)
                == (NULL)) || rtmGetStopRequested(proj_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(proj_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
